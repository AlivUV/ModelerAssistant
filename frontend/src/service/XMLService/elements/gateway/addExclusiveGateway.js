...
/**
 * Modify the current diagram by adding an exclusive gateway at the specified participant.
 ...
 */
const addExclusiveGateway = (gateName, participantId, bpmn) => {
...
export default addExclusiveGateway;